...
#End Region
        Private privateUseSynchronizationContext As Boolean
        Public Property UseSynchronizationContext() As Boolean _
            Implements IReportDesignerServiceClient.UseSynchronizationContext
            Get
                Return privateUseSynchronizationContext
            End Get
            Set(ByVal value As Boolean)
                privateUseSynchronizationContext = value
            End Set
        End Property
    End Class
End Namespace
