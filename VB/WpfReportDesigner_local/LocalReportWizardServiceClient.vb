...
Namespace WpfReportDesigner_local
	Friend Class LocalReportWizardServiceClient
		...
		Public Sub GetColumnsAsync(ByVal dataSourceName As String, ByVal dataMemberName As TableInfoName, ByVal asyncState As Object) Implements IReportWizardServiceClient.GetColumnsAsync
			RaiseScalarOperationCompletedEvent(GetColumnsCompletedEvent, ReportService.GetColumns(dataSourceName, dataMemberName), asyncState)
		End Sub
