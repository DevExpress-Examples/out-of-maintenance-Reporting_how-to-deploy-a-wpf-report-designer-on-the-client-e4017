...
namespace WpfReportDesigner_local {
    class LocalReportWizardServiceClient : LocalReportServiceClient, IReportWizardServiceClient {
        ...
        public void GetColumnsAsync(string dataSourceName, TableInfoName dataMemberName, object asyncState) {
            RaiseScalarOperationCompletedEvent(GetColumnsCompleted, ReportService.GetColumns(dataSourceName, dataMemberName), asyncState);
        }
