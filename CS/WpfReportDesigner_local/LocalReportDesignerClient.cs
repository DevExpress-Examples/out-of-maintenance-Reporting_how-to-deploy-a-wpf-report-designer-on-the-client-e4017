...
namespace WpfReportDesigner_local {
    class LocalReportDesignerClient : LocalReportServiceClient, IReportDesignerServiceClient {
        ...
        public void GetTablesAsync(string dataSourceName, object asyncState) {
            RaiseScalarOperationCompletedEvent<IEnumerable<TableInfo>>(GetTablesCompleted, ReportService.GetTables(dataSourceName), asyncState);
        }
        ...
        public void GetViewsAsync(string dataSourceName, object asyncState) {
            RaiseScalarOperationCompletedEvent<IEnumerable<TableInfo>>(GetViewsCompleted, ReportService.GetViews(dataSourceName), asyncState);
        }
